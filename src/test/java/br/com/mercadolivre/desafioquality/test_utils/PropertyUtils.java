        ...
        properties.addAll(
                List.of(
                        Property
                                ...
                                .propRooms(List.of(Room.builder().roomName("Ola").roomWidth(2.0).roomLength(34.0).build()))
                                .propArea(68.0)
                                .propValue(BigDecimal.valueOf(68).multiply(neighborhoods.get(0).getValueDistrictM2()))
                                .build(),
                        Property
                                .builder()
